...
import com.example.parthnaik.beerbuddy.WebServiceConstant;
...
public class Sessionmanager {
    ...
    public void CreateLoginSession(Integer userid, String name, String mail, String Password)
    {
    ...
    public class LogOut extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            try {
                ...
                URL url = new URL("http://"+ WebServiceConstant.ip+"/beerbuddy/logoutUser.php?" + param);
